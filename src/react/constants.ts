...
export const errors = {
	...
	ADDRESS_FORMAT_ERROR: "Please enter a valid BOA address.",
	WITHDRAW_ADDRESS_REQUIRED: "Please enter an BOA address.",
...
export const tooltips = {
	...
	ETH1_WITHDRAW_ADDRESS: "An optional BOA address for the withdrawal credentials.",
	BTEC_WITHDRAW_ADDRESS: "An BOA address for withdrawal. There is where your validator balance and rewards will go.",
